		...
		<div class="row" id="content">
			...
			<form action="eupdate.action" method="post" class="form-horizontal">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-10">
				      <input type="text" class="form-control" id="name" value="${bean.name }">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-10">
				      <input type="text" class="form-control" id="sub" value="${bean.sub }">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-10">
				      <input type="text" class="form-control" id="pay" value="${bean.pay }">
				    </div>
				  </div>
				 <div class="form-group">
