		...
		<div class="row" id="content">
			<div class="col-md-12">
				...
				<div class="page-header">
					<h1>
						Detail page <small>dept table</small>
					</h1>
				</div>
				...
				<a href="edit.bit?idx=${bean.deptno }" class="btn btn-primary" role="btn">Edit</a>
				<a href="delete.bit?idx=${bean.deptno }" class="btn btn-danger" role="btn">Delete</a>
			</div>
